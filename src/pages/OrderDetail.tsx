       ...
       <div className="grid gap-6 lg:grid-cols-3">
         ...
         <div className="space-y-6 lg:col-span-2">
           ...
           <div className="rounded-lg border bg-card p-6 card-shadow">
             <h2 className="mb-4 text-lg font-semibold">Order Info</h2>
             <div className="grid gap-4 sm:grid-cols-2">
               <div className="space-y-3">
                 <div>
                   <span className="text-xs font-medium uppercase text-muted-foreground">Order ID</span>
                   <p className="font-semibold text-primary">#{orderData.id}</p>
                 </div>
                 <div>
                 ...
                 <div>
                   <span className="text-xs font-medium uppercase text-muted-foreground">Gateway Fee</span>
                   <p className="font-medium">{orderData.gatewayFee}</p>
                 </div>
               </div>
               <div className="space-y-3">
                 <div>
                   <span className="text-xs font-medium uppercase text-muted-foreground">Internal ID</span>
                   <p className="font-medium">{orderData.internalId}</p>
                 </div>
                 <div>
                   <span className="text-xs font-medium uppercase text-muted-foreground">Ext. Delivery Fee</span>
                   <p className="font-medium">{orderData.extDeliveryFee}</p>
                 </div>
                 <div>
                   <span className="text-xs font-medium uppercase text-muted-foreground">Est. Earn Points</span>
           ...
           <div className="rounded-lg border bg-card p-6 card-shadow">
             ...
             <div className="space-y-4">
               {orderData.items.map((item, index) => (
                 <div key={index} className="rounded-lg border bg-background/50 p-4">
                   <div className="flex items-start justify-between">
                     <div className="flex gap-4">
                       ...
                       <div>
                         ...
                         {item.addons.length > 0 && (
                           <div className="mt-2">
                             <span className="text-xs font-medium uppercase text-muted-foreground">Addons</span>
                         ...
                         {item.modifiers.length > 0 && (
                           <div className="mt-2">
                             <span className="text-xs font-medium uppercase text-muted-foreground">Modifiers</span>
                     ...
                     <div className="text-right">
                       <span className="text-lg font-semibold">{item.qty}x</span>
         ...
         <div className="space-y-6">
           ...
           <div className="rounded-lg border bg-card p-6 card-shadow">
             ...
             <div className="space-y-4">
               <div className="flex items-start gap-3">
                 ...
                 <div>
                   <span className="text-xs font-medium uppercase text-muted-foreground">Branch</span>
               ...
               <div className="flex items-start gap-3">
                 ...
                 <div>
                   <span className="text-xs font-medium uppercase text-muted-foreground">Delivery Address</span>
             ...
             <div className="space-y-4">
               <div className="flex items-start gap-3">
                 ...
                 <div>
                   ...
                   <p className="font-medium text-primary">{orderData.customer.name}</p>
                 </div>
               </div>
               <div className="flex items-start gap-3">
               ...
               <div className="flex items-start gap-3">
                 ...
                 <div>
                   <span className="text-xs font-medium uppercase text-muted-foreground">Device</span>
           ...
           {/* Status Badge */}
           <div className="rounded-lg bg-info p-6 text-center text-info-foreground">
             <h3 className="text-xl font-semibold">Kitchen Accepted</h3>
           </div>
                 ...
                 <div key={index} className="relative">
                   <div
                     className={`absolute -left-4 top-1 h-3 w-3 rounded-full ${
                       event.isActive ? "bg-info" : "bg-muted"
                     }`}
                   />
                   <div>
           ...
           {/* Courier Details */}
           <div className="rounded-lg border bg-card p-6 card-shadow">
             <h2 className="mb-4 text-lg font-semibold">Courier Details</h2>
           ...
           {/* Evaluation Details */}
           <div className="rounded-lg border bg-card p-6 card-shadow">
             <h2 className="mb-4 text-lg font-semibold">Evaluation Details</h2>
